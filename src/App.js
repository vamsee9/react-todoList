...
class App extends Component {
	...
	handleEdit = id => {
    const filteredItems = this.state.items.filter((item) => item.id !== id); // My Experiments
        ...
        <div className="row">
          <div className="col-10 col-md-8 mx-auto mt-4">
            ...
            <TodoList
              ...
              handleDeleteDoneTasks={this.handleDeleteDoneTasks} // My Experiments
              updateTodosToShow={this.updateTodosToShow} // My Experiments
            />
          </div>
        </div>
      </div>
